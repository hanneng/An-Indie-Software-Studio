    ...
    <section id="roadmap" className="px-6 py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {/* Now */}
          <FadeIn delay={0}>
            <div className="h-full rounded-2xl border border-accent/30 bg-card p-6 transition-all duration-300 hover:shadow-lg hover:shadow-accent/5">
          ...
          {/* Next */}
          <FadeIn delay={0.1}>
            <div className="h-full rounded-2xl border border-card-border bg-card p-6 transition-all duration-300 hover:border-accent/20 hover:shadow-lg hover:shadow-accent/5">
              <h3 className="text-lg font-semibold text-foreground">
                {roadmap.next.title}
              </h3>
              <ul className="mt-4 space-y-3">
